...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_main_styl__ = __webpack_require__(4);
...
const renderTimeline = svg => {
    ...
    const nonZeroMonths = __WEBPACK_IMPORTED_MODULE_0_d3__["timeMonth"].filter(d => (d.getUTCMonth() !== 0))
    Object(__WEBPACK_IMPORTED_MODULE_0_d3__["select"])('.monthAxis')
        .attr('transform', leavePadding)
    ...
    window._linksPromise.then(links => {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__circleChart__["a" /* default */])({
            ...
            scale: tScale,
            svgEl: svg,
            rootSelection: Object(__WEBPACK_IMPORTED_MODULE_0_d3__["select"])('.bubbleRoot').append('g').attr('transform', leavePadding)
        })
    })
}
...
const homepageMain = () => {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_d3__["json"])(GITHUB_URL, (err, repos) => {
        err
            ? console.error(err)
            : renderRepos(repos)
    })
...
/* harmony default export */ __webpack_exports__["a"] = (homepageMain);
...
function circleChart({svgEl, rootSelection, scale, data = []}) {
    ...
    links.append('line')
        ...
        .attr('y2', function() { return parseFloat(Object(__WEBPACK_IMPORTED_MODULE_0_d3__["select"])(this).attr('y1')) - 45 })
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../js/stylepack/node_modules/css-loader/index.js??ref--0-1!../../js/stylepack/node_modules/stylus-loader/index.js!./main.styl", function() {
			var newContent = require("!!../../js/stylepack/node_modules/css-loader/index.js??ref--0-1!../../js/stylepack/node_modules/stylus-loader/index.js!./main.styl");
