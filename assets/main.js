...
/***/ function(module, exports, __webpack_require__) {
	...
	var d3 = __webpack_require__(5);
	var forceChart = __webpack_require__(4);
	...
	module.exports = function circleChart(config) {
	  ...
	  .x(x.fromDateString({ propName: config.timeProp })).padding(1).y(yBaseline).r(radius).xGravity(3) // make the x-position more accurate
